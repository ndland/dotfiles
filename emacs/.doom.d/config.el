...
;; accept. For example:
;;
(setq doom-font (font-spec :family "MonaspiceAr Nerd Font" :size 13 :weight 'semi-light)
     doom-variable-pitch-font (font-spec :family "MonaspiceAr Nerd Font" :size 13))
;;
